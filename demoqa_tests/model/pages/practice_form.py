...
from demoqa_tests.model.controls.chekboxes import select_chekbox
from demoqa_tests.model.controls.select_dates_on_the_calendar import select_dates_on_the_calendar
from demoqa_tests.model.controls.dropdown import dropdown_react
from demoqa_tests.model.controls.radio_button import select_radio
...
def check_get_form(firstName, lastName, userEmail, gender, Number,  file, date, Subjects, Hobbies, State, City, Address):
